...
# ================================
raster_path <- "data/derived/projection_rasters/rcp245_lu2/predictor_stack_rcp245_lu2.tif"
...
output_path <- "data/derived/maxent_projection_outputs/prediction_rcp245_lu2.tif"
