...
# ================================
raster_path <- "data/derived/projection_rasters/rcp585_lu1/predictor_stack_rcp585_lu1.tif"
...
# ================================
output_path <- "data/derived/maxent_projection_outputs/prediction_rcp585_lu1.tif"
