...
nlyr(stack_rcp245_lu1)  # Check number of layers
names(stack_rcp245_lu1)
# Rename layers to consistent names
names(stack_rcp245_lu1) <- c(
...
writeRaster(
  stack_rcp245_lu1,
  filename = "data/derived/projection_rasters/rcp245_lu1/predictor_stack_rcp245_lu1.tif",
  overwrite = TRUE
)

cat("✅ Raster stack for RCP4.5 + LU1 saved.\n")
